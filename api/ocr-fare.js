...
const SYSTEM_PROMPT =
  '너는 택시 미터기 또는 영수증 사진에서 최종 결제 금액을 읽는 도구야. ' +
  '사진에 여러 숫자가 있으면 "요금 / 합계 / 총액 / 결제금액 / 카드승인금액"에 해당하는 최종 지불액(원)을 고른다. ' +
  '거리(km)나 시간, 전화번호, 사업자번호, 날짜는 금액이 아니다. ' +
  '숫자를 못 읽거나 택시 요금 사진이 아니면 amount는 null. ' +
